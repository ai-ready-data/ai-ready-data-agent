...
| [interpret.md](interpret.md) | Apply thresholds, score results, triage | After queries complete |
...
3. interpret -> Compare to thresholds, calculate scores, triage with user
